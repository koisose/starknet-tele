            ...
            <div className="space-y-4">
              ...
              {connected && <Button onClick={async () => {
                ...
                notification.success(
                  <span className="text-white">Transaction completed successfully! check your <a href="https://web.telegram.org/k/#@starknetai_bot">telegram</a> for receipt </span>,
                  {
                    icon: "🎉",
                    duration: 30000
                  },
                );
                const data = await postData('/api/sendmessage', { chatId, text: `Congrats on sending ${amount} ${selectedToken} to ${address.slice(0, 5)}...${address.slice(-5)} here's the receipt [${result.transaction_hash}](https://sepolia.voyager.online/tx/${result.transaction_hash})` })
                console.log(data)
